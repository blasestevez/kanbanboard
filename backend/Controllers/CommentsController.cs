...
public class CommentsController : ControllerBase
{
    ...
    public CommentsController(ICardService cardService)
    {
    ...
    public async Task<IActionResult> UpdateComment(Guid id, [FromBody] UpdateCommentRequest request, CancellationToken cancellationToken)
    {
        ...
        var result = await _cardService.UpdateCommentAsync(id, request, currentUserId, cancellationToken);
        if (!result.IsSuccess)
        {
    ...
    public async Task<IActionResult> DeleteComment(Guid id, CancellationToken cancellationToken)
    {
        ...
        var result = await _cardService.DeleteCommentAsync(id, currentUserId, cancellationToken);
        if (!result.IsSuccess)
        {
            return ToProblemDetails(result);
        }
